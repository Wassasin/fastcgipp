//! \file http.hpp Declares the Fastcgipp::Sql::MySQL namespace
/***************************************************************************
...
namespace Fastcgipp
{
	...
	namespace Sql
	{
		...
		namespace MySQL
		{
			 ...
			 */
			class Connection: public ConnectionPar< ::Fastcgipp::Sql::MySQL::Statement >
			{
			public:
				/** 
			 ...
			 */
			class Statement: public ::Fastcgipp::Sql::Statement
			{
			public:
				/** 
				 * @brief Complete Constructor
				 ...
				 * Fastcgipp::Sql::Data::Set::numberOfSqlElements() on parameterSet. Similarly, the number of returned result columns
				 ...
				 */
				inline void queue(const boost::shared_ptr<Data::Set>& parameters, const boost::shared_ptr<Data::SetContainerPar>& results, const boost::shared_ptr<unsigned long long int>& insertId, const boost::shared_ptr<unsigned long long int>& rows, const boost::function<void (Message)>& callback)
				{
	...
	{
		/** 
		 * @brief Exception for %MySQL related errors.
		 */
		struct MySQL: public Fastcgipp::Exceptions::CodedException
		{
			MySQL(MYSQL* mysql);
			MySQL(MYSQL_STMT* stmt);
			MySQL(const MySQL& e): CodedException(e.msg, e.erno) {}
		};
	}
}
