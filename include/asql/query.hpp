...
namespace ASql
{
	...
	//! Query specialization for results of Data::SetContainer type and parameters of Data::SetContainer type
	/*!
	 ...
	 */
	template<class Parameters, class Results>
	struct Query<Parameters, Results, typename boost::enable_if<boost::is_base_of<Data::SetContainer, Parameters> >::type,  typename boost::enable_if<boost::is_base_of<Data::SetContainer, Results> >::type>: public QueryPar
	{
	...
	//! Query specialization for results of Data::Set type and parameters of Data::SetContainer type
	/*!
	 * \tparam Parameters Type used to store parameter data. This specialization cover those types derived from Data::SetContainer
	 * \tparam Results Type used to store result data. This specialization cover those types derived from Data::Set
	 */
	template<class Parameters, class Results>
	struct Query<Parameters, Results, typename boost::enable_if<boost::is_base_of<Data::SetContainer, Parameters> >::type,  typename boost::enable_if<boost::is_base_of<Data::Set, Results> >::type>: public QueryPar
	{
		Query(): QueryPar(false, true) {}
		Query(const Query& x): QueryPar(x) {}
